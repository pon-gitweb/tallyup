...
export function generateAbductiveInsights(inputs: AbductiveInputs): AbductiveInsight[] {
  ...
  const {
    totalVarianceDollars, prevVarianceDollars, stockAccuracy: _stockAccuracy,
    labourEfficiency: _labourEfficiency, avgCycleDays: _avgCycleDays, totalStocktakesCompleted,
    pricedItemFraction: _pricedItemFraction, paretoItems, daysOfCover, operationalStockValue,
    inventoryHealth: _inventoryHealth,
  } = inputs;
