...
export const GUIDE_STEPS: Omit<GuideStep, 'completed' | 'dismissed'>[] = [
  { id: 'venue_created', title: 'Create your venue', description: 'Your venue is the home base for everything in Hosti.', tip: "You've already done this one — nice work! 🎉", action: 'View settings', actionRoute: 'Settings' },
