 ...
 *
 * Extracted verbatim from StockHoldingScreen.tsx lines 121-141 — zero logic
 * change. Callers are expected to fetch the snapshot themselves:
 ...
 *
 * Extracted verbatim from StockHoldingScreen.tsx lines 146-156 — zero logic
 * change. prodById is now an explicit parameter instead of a closure variable.
 */
