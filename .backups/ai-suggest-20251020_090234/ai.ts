...
/** Named exports (always available) */
 ...
 * Some callsites import default as a *string* (AI_BASE_URL),
 * others expect default to have properties (AI.AI_SUGGEST_ORDERS_URL).
 * We satisfy both by exporting a String object with properties attached.
 */
